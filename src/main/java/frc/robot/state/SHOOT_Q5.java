...
public class SHOOT_Q5 implements BasicState {
...
public void execute(StateManager stateManager){
    ...
    // stateManager.addDesiredData(CommandConstants.TURRET_KEY, 0.0416666);
    // stateManager.addDesiredData(CommandConstants.WRIST_KEY, 0.56);
    stateManager.addDesiredData(CommandConstants.SHOOTER_FLYWHEEL_KEY, 0.5);
