...
public class SHOOT_Q7 implements BasicState {
...
public void execute(StateManager stateManager){
    ...
    // stateManager.addDesiredData(CommandConstants.TURRET_KEY, 0.105555);
    // stateManager.addDesiredData(CommandConstants.WRIST_KEY, 0.6);
