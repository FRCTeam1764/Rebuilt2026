...
public final class Constants {
    ...
    public static final CanPort SHOOTER_WRIST_MOTOR = new CanPort(2);
    public static final CanPort SHOOTER_ROLLER_MOTOR = new CanPort(2);
    public static final CanPort INTAKE_MOTOR = new CanPort(3);
    public static final CanPort INTAKE_WRIST_MOTOR = new CanPort(4);
    public static final CanPort INDEX_MOTOR = new CanPort(4);
    public static final CanPort CLIMBER_MOTOR = new CanPort(5);
